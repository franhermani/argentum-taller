...
void GameRender::loadSurfacePaths() {
    ...
    floorItemSurfacesMap = {
            {ESPADA, new Surface("../client/resources/images/espada_t.png",
                    window, 0)},
            {HACHA, new Surface("../client/resources/images/hacha_t.png",
                    window, 0)},
            {MARTILLO, new Surface("../client/resources/images/martillo_t.png",
                    window, 0)},
            {VARA_FRESNO, new Surface("../client/resources/images/vara_fresno_t.png",
                    window, 0)},
            {FLAUTA_ELFICA, new Surface("../client/resources/images/flauta_elfica_t.png",
                    window, 0)},
            {BACULO_NUDOSO, new Surface("../client/resources/images/baculo_nudoso_t.png",
                    window, 0)},
            {BACULO_ENGARZADO, new Surface("../client/resources/images/baculo_engarzado_t.png",
                    window, 0)},
