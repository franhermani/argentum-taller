...
// TODO: pasarle posConverter y cargar granularPos
...
Attack::Attack(LivingBeing *owner, const int type, const int sound,
        ...
        pos(new_pos), granularPos(pos), direction(direction), range(range),
        blocksToRange(range), isColliding(false), moveVelocity(move_velocity),
        msMoveCounter(0) {}
